                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <p class="mt-2">
                                        <b>Who can see data I provide in the application?</b><br>
                                        Information that you provide about your books, music albums etc. may be visible to other site users or visitors.
                                        Some elements added by you (e.g. Artist names, tags) are available for other users as well.
                                    </p>
