    ...
    <div class="w-full max-w-2xl">
        ...
        <form id="edit" method="POST" action="/books/{{ $itemable->id }}">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div>
                    <x-primary-button type="button"
                                      ...
                                      onclick="window.ajaxGetDetailsWithISBN('edit');"
            ...
            <div class="grid grid-cols-4 sm:gap-2 gap-1">
                <div class="sm:col-span-2 col-span-full">
                    ...
                    <x-itemable.form.input type="text"
                                           id="series"
                                           name="series"
                                           value="{{ old('series') ?? $itemable->series }}"
                ...
                <div class="sm:col-span-1 col-span-2">
                    ...
                    <x-itemable.form.input type="number"
                                           id="volume"
                                           name="volume"
                                           value="{{ old('volume') ?? $itemable->volume }}"
                ...
                <div class="sm:col-span-1 col-span-2">
                    ...
                    <x-itemable.form.input type="number"
                                           id="pages"
                                           name="pages"
                                           value="{{ old('pages') ?? $itemable->pages }}"
            ...
            <x-itemable.form.provide-hidden
                ...
                formId="edit"
                hiddenInputName="authors[]"
                :values="$itemable->getAuthors()->map(fn($artist) => $artist->getName())"
            />
