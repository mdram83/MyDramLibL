<div class="w-full flex justify-center">
    <div class="w-full max-w-2xl">
        ...
        <form id="edit" method="POST" action="/music/{{ $itemable->id }}">
            @csrf
            @method('PATCH')
...
{{--                                              onclick="window.ajaxGetDetailsWithISBN('create');"--}}
            ...
            <input type="hidden"
                   id="thumbnail"
                   name="thumbnail"
                   value="{{ old('thumbnail') ?? $itemable->item->thumbnail}}"
            />
            ...
            <x-itemable.form.input type="text"
                                   id="title"
                                   name="title"
                                   value="{{ old('title') ?? $itemable->item->title}}"
            ...
            <div class="grid grid-cols-2 gap-1">
                <div>
                    ...
                    <x-itemable.form.input type="time"
                                           ...
                                           min="00:00:00"
                                           max="99:99:99"
                                           value="{{ old('duration') ?? $itemable->duration }}"
                ...
                <div>
                    ...
                    <x-itemable.form.input type="number"
                                           id="volumes"
                                           name="volumes"
                                           value="{{ old('volumes') ?? $itemable->volumes}}"
            ...
            <div class="grid grid-cols-4 sm:gap-2 gap-1">
                ...
                <div class="sm:col-span-3 col-span-full">
                    ...
                    <x-itemable.form.input type="text"
                                           ...
                                           value="{{ old('publisher') ?? $itemable->item->publisher?->name }}"
                ...
                <div class="sm:col-span-1 col-span-full">
                    ...
                    <x-itemable.form.input type="number"
                                           id="published_at"
                                           name="published_at"
                                           value="{{ old('published_at') ?? $itemable->item->published_at }}"
            ...
            <x-itemable.form.provide-hidden
                ...
                formId="edit"
                hiddenInputName="tags[]"
                :values="$itemable->item->tags->map(fn($tag) => $tag->name)"
            />
            ...
            <x-itemable.form.provide-hidden
                ...
                formId="edit"
                hiddenInputName="mainArtists[]"
                :values="$itemable->getMainArtists()->map(fn($artist) => $artist->getName())"
            />
            ...
            <x-itemable.form.provide-hidden
                ...
                formId="edit"
                hiddenInputName="mainBands[]"
                :values="$itemable->getMainBands()->map(fn($guild) => $guild->name)"
            />
            ...
            <x-itemable.form.textarea id="comment"
                                      ...
                                      rows="3"
            >{{ old('comment') ?? $itemable->item->comment }}</x-itemable.form.textarea>
